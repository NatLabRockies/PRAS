...
The `DemandResponseEnergy` result specification reports the average energy borrowed
...
energy borrowed level for the given demand response device in that timestep.
